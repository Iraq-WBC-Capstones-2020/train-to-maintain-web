...
function WorkoutCard(props) {
  return (
    <div class="max-w-sm rounded overflow-hidden shadow-lg">
      ...
      />
      <div class="px-6 py-4">
        <div class="flex justify-center items-center font-bold text-xl  text-center m-10 text-pinky-500 font-poppins">
          FAT LOSE WORKOUTS
        </div>
      </div>
