...
const BlogPosts = () => {
  return (
    <section className="flex flex-col items-center bg-secondary">
      <h1 className=" md:text-3xl text-xl text-center font-bold text-darkgray my-5">
        Nutrition, Health, and working out blogs
      </h1>

      <div className=" flex flex-col  items-center blog-posts  disable-scrollbar  w-screen md:h-xl h-xxl">
        <BlogCard
